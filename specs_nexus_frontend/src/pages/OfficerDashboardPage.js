      ...
      <div className="officer-dashboard-page">
        ...
        <div className="card analytics-section">
          ...
          <div className="stats-row">
            <div className="stat-box">
              <p>Not Paid</p>
              <h2>{paymentAnalytics.notPaid}</h2>
            </div>
            <div className="stat-box">
              <p>Verifying</p>
              <h2>{paymentAnalytics.verifying}</h2>
            </div>
            <div className="stat-box">
              <p>Paid</p>
              <h2>{paymentAnalytics.paid}</h2>
            </div>
          </div>
          <div className="chart-box">
        ...
        <div className="card analytics-section">
            ...
            {eventsData.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={eventsData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="participation_rate" fill="#82ca9d" name="Participation Rate (%)" />
                </BarChart>
              </ResponsiveContainer>
            ) : (
          ...
          <div className="chart-box">
            <h3>Popular Events (Pie Chart)</h3>
        ...
        <div className="card analytics-section">
          ...
          <div className="chart-box">
            ...
            {clearanceByRequirementData.length > 0 ? (
              clearanceByRequirementData.map((item, index) => (
                <ResponsiveContainer key={index} width="100%" height={250}>
                  <BarChart data={[item]} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="Clear" fill="#28a745" name="Clear" />
                    <Bar dataKey="Not Yet Cleared" fill="#ff4d4d" name="Not Yet Cleared" />
                  </BarChart>
                </ResponsiveContainer>
              ))
            ) : (
